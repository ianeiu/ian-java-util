...
public final class EmailUtil {
     ...
     * 初始化方法
     */
    public EmailUtil(Map<String,Object> configMap,boolean debug) {

        this.mailHost = (String) configMap.get("mail.smtp.host");
        this.port = (int) configMap.get("mail.smtp.port");
        this.auth = (boolean) configMap.get("mail.smtp.auth");
        this.sender_username = (String) configMap.get("mail.sender.username");
        this.sender_password = (String) configMap.get("mail.sender.password");
